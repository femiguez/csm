...
sunflower. The Fibonacci sequence is defined as
...
Jones 2009 we have a nice example of flow control, Figure
\ref{fig:r-flow}.

\begin{figure}[htpb!]
  \centering
  \includegraphics{./figs/r-flow.png}
  \caption{Scanned page from Jones 2009 illustrating program flow.}
  \label{fig:r-flow}
\end{figure}
...
Similarly, we can turn to the logistic equation and build an R function (without
